public class Main {
    ...
    public static void main(String[] args) {
        ...
        g1.addEdgeUnor(7, 5, 1);
        g1.addEdgeUnor(7, 1, 1);
        g1.addEdgeUnor(7, 2, 1);
        g1.addEdgeUnor(1, 0, 1);
        g1.addEdgeUnor(1, 4, 1);
        g1.addEdgeUnor(2, 3, 1);
        g1.addEdgeUnor(5, 6, 1);
        g1.addEdgeUnor(6, 8, 1);
